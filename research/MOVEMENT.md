...
- Free roam schedules jumps after 8–16 seconds and portals after 25–45 seconds of available floor time. Airborne travel, throws, landings, hovering, and interaction do not consume those timers. A brief grace period separates actions; manual jumps restart the jump timer, while portals and focus changes restart both.
- Autonomous portals choose visible floor destinations at least 1.5 character widths (and at least 120 points) away, across any connected display. If a narrow desktop has no useful destination, Rick skips the portal and continues roaming. Autonomous movement uses the existing physics and effects without adding voice requests outside the occasional-chatter schedule.
